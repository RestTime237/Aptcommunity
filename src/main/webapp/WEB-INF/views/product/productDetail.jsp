                ...
                <div class="content-card">
                    <div class="product-info">
                        ...
                        <div class="d-flex flex-wrap gap-2 mb-4">
                            ...
                            <!-- 찜 버튼 -->
                            <button id="wishlistBtn" class="btn btn-wishlist ${isWishlisted ? 'active' : ''}" data-product-id="${product.id}">
                                                    ...
                                                    <c:if test="${reply.parentId eq comment.id}">
                                                        <div class="reply-item animate-fade-in">
                                                            ...
                                                            <c:if test="${reply.userId == mb.userId || mb.role >= 3}">
                                                                <div class="comment-actions btn-group-sm">
                                                                    <button type="button" id="replyEditBtn" class="btn btn-sm btn-outline-primary" data-id="${reply.id}" data-ref-type="product" data-ref-id="${product.id}">
                                                                        <i class="bi bi-pencil"></i>
                                                                    </button>
                                                                    <button type="button" id="replyDeleteBtn" class="btn btn-sm btn-outline-danger" data-id="${reply.id}" data-ref-type="product" data-ref-id="${product.id}">
                                                                        <i class="bi bi-trash"></i>
                                                                    </button>
                                                                </div>
                                                            </c:if>
                ...
                <div class="content-card mb-4">
                    <div class="product-info">
                        ...
                        <div class="text-center mt-3">
                            <a href="/AptCommunity/product/list?userId=${product.userId}" class="btn btn-sm btn-outline-primary">
        ...
        <a href="/AptCommunity/product/detail?id=${p.id}" class="text-decoration-none text-dark">
          <div class="card related-product-card h-100">
            <div class="related-product-img">
              <c:choose>
                <c:when test="${not empty p.image}">
                  <img src="${p.image}?height=160&width=240" alt="${p.name}" class="w-100 object-fit-cover" />
                </c:when>
                <c:otherwise>
                  <img src="/AptCommunity/resources/images/default-image.png" alt="${p.name}" class="w-100 object-fit-cover" />
                </c:otherwise>
              </c:choose>
            </div>
                ...
                <div class="modal-body">
                    <form id="reportForm">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="reportDetail" name="detail" rows="4" placeholder="신고 내용을 자세히 적어주세요" required></textarea>
                        </div>
                    </form>
                </div>
