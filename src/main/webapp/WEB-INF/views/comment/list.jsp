    ...
    <c:if test="${empty comment.parentId}">
        <div class="comment-item border-top pt-2 mt-1">
            ...
            <div class="d-flex gap-2 mt-2 align-items-center">
                <button class="btn btn-sm btn-outline-primary reply-toggle d-flex align-items-center"
                        data-comment-id="${comment.id}">
                    <i class="bi bi-reply me-1"></i> 답글
                </button>
                <button class="btn btn-sm btn-outline-secondary toggle-replies-btn d-flex align-items-center"
                        data-comment-id="${comment.id}">
