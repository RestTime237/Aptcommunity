                    ...
                    <c:choose>
                        <c:when test="${chatRoom.user1 eq userId}">
                            <c:if test="${not empty opponent.profileImage}">
                                <img class="partner-avatar" src="${pageContext.request.contextPath}/resources/images/${opponent.profileImage}">
                            </c:if>
        ...
        <div class="chat-input">
            ...
            <form id="chat-form">
			    <div class="chat-input-wrapper position-relative">
			        <textarea id="messageContent" class="message-input" placeholder="메시지를 입력하세요..." rows="1" required></textarea>
