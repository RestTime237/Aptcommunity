...
<head>
    ...
    <style>
        ...
        .weather-widget::before {
            ...
            bottom: 0;
            left: 0;
            background: url('${pageContext.request.contextPath}/resources/images/weather-pattern.svg');
            background-size: cover;
            opacity: 0.1;
        }
        ...
        .dust-widget::before {
            ...
            bottom: 0;
            left: 0;
            background: url('${pageContext.request.contextPath}/resources/images/dust-pattern.svg');
            background-size: cover;
            opacity: 0.1;
        }
                ...
                <div class="col-lg-8 text-center">
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-3">
                                <div class="bg-white bg-opacity-25 rounded-circle p-2 me-3">
                                    <c:if test="${mb.profileImage != null || !mb.profileImage == ''}">
                                        <img src="${pageContext.request.contextPath}/resources/images/${mb.profileImage}" class="chat-profile-img">
                                    </c:if>
                                    <c:if test="${mb.profileImage == null || mb.profileImage == ''}">
                    ...
                    <c:if test="${empty mb}">
                        <div class="animate-fade-in" style="animation-delay: 0.4s;">
                            ...
                            <a href="/AptCommunity/member/login" class="btn btn-light text-primary fw-semibold px-4 py-2 me-2 shadow-sm">
				            ...
				            <div class="popular-post-card">
				                <div class="popular-post-img">
				                    <c:choose>
									  <c:when test="${not empty thumbnailMap[post.id]}">
									    <img src="/AptCommunity/resources/images/${thumbnailMap[post.id]}" alt="인기 게시글" />
									  </c:when>
									  <c:otherwise>
				                ...
				                <div class="popular-post-info">
				                    ...
				                    <div class="popular-post-meta">
				                        ...
				                        <span><i class="bi bi-calendar3 me-1"></i> <fmt:formatDate value="${post.createdAt}" pattern="yyyy.MM.dd"/></span>
				                    </div>
				                </div>
				            </div>
			            </a>
                ...
                <div class="card h-100 shadow-sm widget-card">
                    ...
                    <div class="list-group list-group-flush">
                        <c:forEach var="post" items="${recentPosts}">
                            <a href="/AptCommunity/post/detail?id=${post.id}" class="list-group-item list-group-item-action post-link">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-muted"><i class="bi bi-person-circle me-1"></i> ${nicknameMap[post.userId]}</small>
                                    <small class="text-muted"><i class="bi bi-clock me-1"></i> <fmt:formatDate value="${post.createdAt}" pattern="yyyy-MM-dd HH:mm" /></small>
                                </div>
                            </a>
                        </c:forEach>
                ...
                <div class="card h-100 shadow-sm widget-card">
                    ...
                    <div class="list-group list-group-flush">
                        <c:forEach var="product" items="${recentProducts}">
                            <a href="/AptCommunity/product/detail?id=${product.id}" class="list-group-item list-group-item-action product-link">
                                <div class="d-flex w-100 justify-content-between">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-muted"><i class="bi bi-person-circle me-1"></i> ${nicknameMap[product.userId]}</small>
                                    <small class="text-muted"><i class="bi bi-clock me-1"></i> <fmt:formatDate value="${product.createdAt}" pattern="yyyy-MM-dd HH:mm" /></small>
                                </div>
                            </a>
                        </c:forEach>
