	            ...
	            <div class="vote-header">
	                ...
	                <div class="vote-info">
	                    <div>
	                        ...
	                        <span><i class="bi bi-calendar3 me-1"></i><fmt:formatDate value="${vote.createdAt}" pattern="yyyy-MM-dd HH:mm" /></span>
	                    </div>
	                    <div>
	                        <c:choose>
	                        ...
	                        <c:forEach var="option" items="${vote.voteOptions}" varStatus="status">
	                            <div class="option-item">
	                                <div class="form-check">
	                                    <input class="form-check-input option-radio" type="radio" name="optionId" id="option${status.index}" value="${option.id}" required>
