                ...
                <div class="content-card mb-4">
                    <form action="/AptCommunity/vote/add" method="post" id="voteForm">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="투표 제목을 입력하세요" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="content" name="content" rows="4" placeholder="투표에 대한 상세 설명을 입력하세요"></textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="showResultBeforeEnd" name="showResultBeforeEnd">
