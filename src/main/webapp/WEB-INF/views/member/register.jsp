                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form:input path="username" id="username" class="form-control" required="required" placeholder="실명을 입력하세요" />
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form:input path="nickname" id="nickname" class="form-control" required="required" placeholder="커뮤니티에서 사용할 별명을 입력하세요" />
                                    </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form:input path="userId" id="userId" class="form-control" required="required" placeholder="로그인에 사용할 아이디를 입력하세요" />
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form:input path="password" type="password" id="password" class="form-control" required="required" placeholder="비밀번호를 입력하세요" />
                                    </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="roadAddress" class="form-control" placeholder="도로명 주소" readonly />
