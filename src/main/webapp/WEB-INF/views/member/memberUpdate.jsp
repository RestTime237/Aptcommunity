                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form:input path="username" id="username" cssClass="form-control" placeholder="이름을 입력하세요" />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form:input path="nickname" id="nickname" cssClass="form-control" placeholder="커뮤니티에서 사용할 별명을 입력하세요" />
                                    </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form:password path="password" id="password" cssClass="form-control" placeholder="변경할 비밀번호를 입력하세요" />
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" id="passwordCheck" class="form-control" placeholder="비밀번호를 다시 입력하세요" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="roadAddress" class="form-control" placeholder="도로명주소" readonly />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="jibunAddress" class="form-control" placeholder="지번주소" readonly />
                                    </div>
                                </div>
